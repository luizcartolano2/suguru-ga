...
puzzles = SuguruParser.load_puzzles("instances/easy-back.json")

puzzle = puzzles[0]
solver = SuguruGa(puzzle, population_size=100, generations=1000, mutation_rate=0.3)
solved = solver.solve()
print(solved.validate())
solved.display()
